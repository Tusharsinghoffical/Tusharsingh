...
TIME_ZONE = "Asia/kolkata   "  # Corrected to 'asia/kolkata'
...
# userproject/settings.pys
LOGIN_URL = 'login'          # URL name of login page
LOGIN_REDIRECT_URL = 'home' # Where to go after login
LOGOUT_REDIRECT_URL = 'login' # Where to go after logout

# STATIC_URL = '/static/'

# # Required for collectstatic and deployment
# STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# (Optional for Render or Heroku etc.)
